...
class DBManager:
    def __init__(self):   
        ...
        self.curr.execute('create table if not exists users(id integer primary key autoincrement, fullname text, email text, password text)')
        self.curr.execute('create table if not exists urls(id integer primary key autoincrement, url text, code text, user_id integer, clicks integer)')
        self.conn.commit()
        self.close()
